    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests(authorizeRequests ->
                authorizeRequests
                        ...
                        .antMatchers(HttpMethod.GET, "/api/bloqueios/**").hasAuthority("SCOPE_meu-primeiro-escopo")
                        ...
                        .antMatchers(HttpMethod.POST, "/api/bloqueios/**").hasAuthority("SCOPE_meu-primeiro-escopo")
